       ...
       <% if(listaProposte.isEmpty()){%>
        ...
        %>
          ...
          <td style="width: 400px">              
              <div class="form-inline">
                <label>Azienda:</label>
                <span><%= listaProposte.get(i).getAzienda().getNome() %></span>
              </div>
          </td>
          </tr>    
          <tr>
              ...
              <div class="form-inline" style="text-align: center;">
                <div class="col-sm-offset-2 col-sm-5">
                  <button type="button" class="btn btn-primary" 
                    onclick="accettaRifiutaPropostaTirocinioSicuro('accetta','<%= listaProposte.get(i).getId() %>');">Accetta</button>
                  <button type="button" class="btn btn-primary" 
                   onclick="accettaRifiutaPropostaTirocinioSicuro('rifiuta','<%= listaProposte.get(i).getId() %>');">Rifiuta</button>                  
                </div>
              </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content alert alert-warning">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" onclick="accettaRifiutaPropostaTirocinio();">Si</button>
