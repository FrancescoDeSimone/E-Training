...
public class TestAttivitaRegistroDao {

  private static AttivitaRegistro unAttivita;
  ...
  public static void init() throws Exception{
    ...
    unAttivita = new AttivitaRegistro();
    unAttivita.setTirocinio(unTirocinio);
    unAttivita.setAttivitaSvolta("Conversione mastodontica dei Database");
    unAttivita.setConvalida(AttivitaRegistro.IN_CONVALIDA);
    unAttivita.setInizio(new GregorianCalendar(2018,5,4));
    unAttivita.setFine(new GregorianCalendar(2018,5,20));
    unAttivita.setOreSvolte(10);
  }
  
  @Test
  public void test1_InserimentoAttivita(){
    boolean risultato = AttivitaRegistroDao.salvaAttivitaRegistro(unAttivita);
    
    assertTrue(risultato);
  }
  
  @Test
  public void test2_RicercaAttivita(){
    AttivitaRegistro attivitaRegistro = new AttivitaRegistro();
    attivitaRegistro.setTirocinio(unTirocinio);
    attivitaRegistro.setAttivitaSvolta(unAttivita.getAttivitaSvolta());
        
    AttivitaRegistroDao.ricercaAttivitaRegistro(attivitaRegistro);
    
    assertEquals(unAttivita.getOreSvolte(),attivitaRegistro.getOreSvolte());
  }
  
  @Test
  public void test3_RicercaTutteAttivita(){       
    ArrayList<AttivitaRegistro> listaAttivita = new ArrayList<>();
    AttivitaRegistroDao.ricercaTutteAttivitaRegistro(listaAttivita,unTirocinio);
    
    assertEquals(listaAttivita.size(),1);
  }
  
  @Test
  public void test4_AggiornaConvalida(){
    unAttivita.setConvalida(AttivitaRegistro.CONVALIDATA);
    unAttivita.setMotivazioneRifiuto("Non sono sicuro.");
    
    AttivitaRegistroDao.aggiornaConvalidaAttivita(unAttivita);
    ...
    assertEquals(unAttivita.getMotivazioneRifiuto(),attivitaRegistro.getMotivazioneRifiuto());
  }
  ...
  public static void close() {
    ...
    // Rimuoviamo l'OffertaFormativaTirocinioEsterno, le Facilitazioni, il Tirocinio, gli Obiettivi
    // e l'AttivitaRegistro dal database con un nostro metodo nel test perchè non è offerta 
