...
public class TestVisualizzaOfferteFormativeEsterneInviateServlet {
  ...
  public void test01_SenzaSessione() throws Exception {
    ...
    try {
      new VisualizzaOfferteFormativeEsterneInviateServlet().doGet(request, response);      
  ...
  public void test02_Successo() throws Exception {
    ...
    when(sessione.getAttribute("utente")).thenReturn(new Azienda());
