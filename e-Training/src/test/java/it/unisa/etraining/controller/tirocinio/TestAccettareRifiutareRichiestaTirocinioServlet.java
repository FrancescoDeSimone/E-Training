...
public class TestAccettareRifiutareRichiestaTirocinioServlet {
  ...
  public void test01_SessioneNull() throws ServletException, IOException {    
    ...
    try {
      new AccettareRifiutareRichiestaTirocinioServlet().doGet(request, response);
  ...
  @Test
  public void test02_ParamsNull() throws ServletException, IOException {    
    sessione.setAttribute("utente", unAzienda);
    when(request.getSession(false)).thenReturn(sessione);    
    when(request.getRequestDispatcher("/accettareRifiutareRichiestaTirocinio.jsp?errore=1")).thenReturn(dispatcher);
  ...
  @Test
  public void test02_ParamsNull2() throws ServletException, IOException {    
    sessione.setAttribute("utente", unAzienda);
    when(request.getSession(false)).thenReturn(sessione);   
  ...
  @Test
  public void test02_ParamsNull3() throws ServletException, IOException {    
    when(request.getSession(false)).thenReturn(sessione);    
    when(sessione.getAttribute("utente")).thenReturn(unAzienda);    
    when(request.getParameter("scelta")).thenReturn("accetta");
    when(request.getParameter("tirocinante")).thenReturn(null);
    when(request.getParameter("id")).thenReturn(""+unOfferta.getId());
    when(request.getRequestDispatcher("/accettareRifiutareRichiestaTirocinio.jsp?errore=1")).thenReturn(dispatcher);
  ...
  @Test
  public void test02_ParamsNull4() throws ServletException, IOException {    
    when(request.getSession(false)).thenReturn(sessione);    
    when(sessione.getAttribute("utente")).thenReturn(unAzienda);    
    when(request.getParameter("scelta")).thenReturn("accetta");
    when(request.getParameter("tirocinante")).thenReturn(unTirocinante.getEmail());
  ...
  @Test
  public void test03_AccettaAzienda() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);    
    when(sessione.getAttribute("utente")).thenReturn(unAzienda);    
    when(request.getParameter("scelta")).thenReturn("accetta");
    when(request.getParameter("tirocinante")).thenReturn(unTirocinante.getEmail());
    ...
    when(request.getRequestDispatcher("/ValutareRichiestaTirocinioServlet")).thenReturn(dispatcher);
  ...
  @Test
  public void test04_RifiutaAzienda() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);    
    when(sessione.getAttribute("utente")).thenReturn(unAzienda);    
  ...
  @Test
  public void test05_AccettaTutorDidattico() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);    
    when(sessione.getAttribute("utente")).thenReturn(unTutorDidattico);    
    when(request.getParameter("scelta")).thenReturn("accetta");
    when(request.getParameter("tirocinante")).thenReturn(unTirocinante.getEmail());
    when(request.getParameter("id")).thenReturn(""+unOfferta.getId());
  ...
  @Test
  public void test06_RifiutaTutorDidattico() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);    
    when(sessione.getAttribute("utente")).thenReturn(unTutorDidattico);    
    when(request.getParameter("scelta")).thenReturn("rifiuta");
    when(request.getParameter("tirocinante")).thenReturn(unTirocinante.getEmail());
