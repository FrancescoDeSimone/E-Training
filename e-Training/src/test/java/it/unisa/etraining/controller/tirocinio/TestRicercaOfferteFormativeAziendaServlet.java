...
public class TestRicercaOfferteFormativeAziendaServlet {
  ...
  public void test01_SessioneNull() throws ServletException, IOException {
    ...
    try {
      new RicercaOfferteFormativeAziendaServlet().doGet(request, response);
  ...
  @Test
  public void test03_AziendaEmpty() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);
  ...
  @Test
  public void test04_RicercaEffettuata() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);
