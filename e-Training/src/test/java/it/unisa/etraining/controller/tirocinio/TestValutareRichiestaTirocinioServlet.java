...
public class TestValutareRichiestaTirocinioServlet {
  ...
  public void test01_SessioneNull() throws ServletException, IOException {
    ...
    try {
      new ValutareRichiestaTirocinioServlet().doGet(request, response);
  ...
  public void test02_SessioneNotNull() throws ServletException, IOException {
    ...
    when(request.getRequestDispatcher("/accettareRifiutareRichiestaTirocinio.jsp"))
