...
public class TestRicercaOffertaFormativaAziendaServlet {
  ...
  public void test01_SessioneNull() throws ServletException, IOException {
    ...
    try {
      new RicercaOffertaFormativaAziendaServlet().doGet(request, response);
  ...
  @Test
  public void test02_TemaNull() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);
    when(request.getParameter("tema")).thenReturn(null);
    when(request.getRequestDispatcher("/effettuaRichiestaTirocinio.jsp?errore=1"))
  ...
  @Test
  public void test03_TemaEmpty() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);
  ...
  @Test
  public void test04_AziendaNull() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);
  ...
  @Test
  public void test05_AziendaEmpty() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);
    when(request.getParameter("tema")).thenReturn(unOfferta.getTema());
    when(request.getParameter("azienda")).thenReturn("");
    when(request.getRequestDispatcher("/effettuaRichiestaTirocinio.jsp?errore=1"))
        .thenReturn(dispatcher);
  ...
  @Test
  public void test06_ParametriGood() throws ServletException, IOException {
    when(request.getSession(false)).thenReturn(sessione);
    when(request.getParameter("tema")).thenReturn(unOfferta.getTema());
