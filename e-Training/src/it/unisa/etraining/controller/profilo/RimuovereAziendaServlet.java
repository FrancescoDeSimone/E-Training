...
/**
 * La servlet <code>RimuovereAziendaServlet</code> gestisce le rimozioni delle aziende.
 *
 */
@WebServlet("/RimuovereAziendaServlet")
public class RimuovereAziendaServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) 
    ...
    boolean flag = profiloFacade.rimuoviAzienda(azienda);
    if (!flag) {
      RequestDispatcher dispatcher = getServletContext()
          .getRequestDispatcher("/rimuovereAziende.jsp?errore=Database!");
      dispatcher.forward(request, response);
    } else {
      RequestDispatcher dispatcher = getServletContext()
          .getRequestDispatcher("/rimuovereAziende.jsp?errore=null!");
      dispatcher.forward(request, response);
    }
  }
