...
/**
 * La servlet <code>AggiungereOffertaFormativaEsternaServlet</code> serve per aggiungere
 * un'offerta formativa di tirocinio esterno.
 * 
 * @author Celentano Antonino
 */
@WebServlet("/AggiungereOffertaFormativaEsternaServlet")
public class AggiungereOffertaFormativaEsternaServlet extends HttpServlet {
  /**
   * Metodo doGet.
   * 
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    boolean flag = offerteFormativeFacade.aggiungereOffertaFormativaEsterna(offerta);
    if (!flag) {
