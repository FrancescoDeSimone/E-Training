...
<body>
	...
	<div class="page">
		...
		<div class="mycontainer containerEsterno">
			<div style="margin: 0 auto; width: 600px">
				<h2>Aggiungi funzionario</h2>
				<form class="form-horizontal" action="/action_page.php">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="qualifiche"
								placeholder="Qualifiche" name="qualifiche" maxlength="250">
						</div>
					</div>
					<div class="form-group">
